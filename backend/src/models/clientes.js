    ...
    (err, results) => {
      if (err) {
        if (typeof callback === "function") {
          ...
          console.error(
            "Se esperaba un callback pero no se proporcionó uno o no es una función."
          );
        }
      } else {
        if (typeof callback === "function") {
          ...
          console.log(
            "Operación exitosa, pero el manejo del callback no es posible porque no se proporcionó una función."
          );
        }
      }
    }
